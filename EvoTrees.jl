...
# ╔═╡ 2ef70643-9f7f-4ea5-a4ca-33707c61d65b
using EvoTrees

# ╔═╡ b27819f6-3bc9-4099-82bf-b0f5abc5c1ad
using EvoTrees: fit

# ╔═╡ 51bbac6e-54c0-4da8-a209-cb6507ded618
using DataFrames

# ╔═╡ cd4355d9-67a0-4cad-8203-996cbfb0a375
...
# ╔═╡ af8afbc0-048a-49ae-b376-19a97f9fbc1e
x_train, y_train = rand(1000,10), rand(1000)

# ╔═╡ b51f9f0d-f61d-429d-96ac-43efce2760f7
dtrain = DataFrame(x_train, :auto)

# ╔═╡ c95c2426-f431-4136-9283-943ad4fbfef7
dtrain.y .= y_train

# ╔═╡ 05412961-06ef-4daa-ac21-a469992cd513
m = fit(config, dtrain; target_name="y")

# ╔═╡ 8712e1a5-d4ae-461f-95fc-03eb651ef3b1
preds = m(dtrain)

# ╔═╡ dec92427-4be9-42b6-91aa-0c99bbf31795
...
manifest_format = "2.0"
project_hash = "12f7ea5b2f87133390221b6e3a5f87cbb41c5dbf"
